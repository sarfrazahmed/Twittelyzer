...
<body>
<div id="wrapper">
	<div id="header"><h1>Lexicon-based sentiment analysis for Twitter</h1> 
</div>
<div id="content">
		<form id="search-form" class="centered" method="get" action="">
		<div class="buttonholder">
			<input type="text"  class="tftextinput" placeholder="Enter Your Country Name"  name="place" size="60"
				maxlength="100"> <br>
			<input type="text" placeholder="Example,, Politics or any" class="tftextinput" name="key" size="60"
				maxlength="100"><br>
  ...
  <div id="footer">Copyright &copy; jpinfotech 2016 <br>
  This website has been created as part of the Java Software Project Developed by Kaviarasan, www.jpinfotech.org
  </div>
